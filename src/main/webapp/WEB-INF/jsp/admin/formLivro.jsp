				...
				<div class="w3-container w3-section">
					...
					<div class="w3-row w3-margin">
						<div class="w3-col m4 l3">
							...
							<form:select path="categoria" class="custom-select" style="width:100px;">
						...
						<div class="w3-col m4 l3">
							...
							<form:select path="editora" class="custom-select" style="width:100px;">
								<form:option value=""> --SELECT--</form:option>
						...
						<div class="w3-col m4 l3">
							...
							<form:select path="autor" class="custom-select" style="width:100px;">
								<form:option value=""> --SELECT--</form:option>
